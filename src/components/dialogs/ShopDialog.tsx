...
const chickensForSale: Chicken[] = [
    { id: 1, name: "Normal Tavuk", imageUrl: "/assets/chickens/chicken1.png", productionRate: 0.1, price: 8 },
    { id: 2, name: "Hızlı Tavuk", imageUrl: "/assets/chickens/chicken1.png", productionRate: 0.2, price: 15 },
    { id: 3, name: "Süper Tavuk", imageUrl: "/assets/chickens/chicken1.png", productionRate: 0.5, price: 35 },
    { id: 4, name: "Altın Tavuk", imageUrl: "/assets/chickens/chicken1.png", productionRate: 1.2, price: 80 },
    { id: 5, name: "Robot Tavuk", imageUrl: "/assets/chickens/chicken1.png", productionRate: 2.5, price: 150 },
    { id: 6, name: "Ninja Tavuk", imageUrl: "/assets/chickens/chicken1.png", productionRate: 5.0, price: 320 },
    { id: 7, name: "Ejderha Tavuk", imageUrl: "/assets/chickens/chicken1.png", productionRate: 10, price: 700 },
    { id: 8, name: "Kozmik Tavuk", imageUrl: "/assets/chickens/chicken1.png", productionRate: 25, price: 1500 },
];
